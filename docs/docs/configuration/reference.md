...
| cl_image        | string  | ethpandaops/lighthouse:unstable | Image for the CL client.                              |
...
| validator_config_generator | string | leovct/pos-validator-config-generator:1.2.3-0.1.12 | Image used to generate validator configs.       |
