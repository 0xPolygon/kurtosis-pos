...
| cl_image      | string | 0xpolygon/heimdall:1.3.3 | Image for the CL client.                                                                |
...
| validator_config_generator | string | leovct/pos-validator-config-generator:1.3.3-0.2.4 | Image used to generate validator configs.       |
