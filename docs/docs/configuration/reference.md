...
| cl_image                         | string | 0xpolygon/heimdall-v2:0.9.0-beta | Image for the CL client                                                                                                                                                                                                                     |
...
| el_image                         | string | 0xpolygon/bor:2.8.3-beta5        | Image for the EL client (bor: `0xpolygon/bor:2.8.3-beta5`, erigon: `0xpolygon/erigon:v3.6.1-beta`)                                                                                                                                          |
...
| validator_config_generator | string | ghcr.io/0xpolygon/pos-validator-config-generator:0.9.0-beta | Image used to generate validator configs    |
