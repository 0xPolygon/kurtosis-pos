...
| cl_image                         | string | 0xpolygon/heimdall-v2:0.9.0-beta2 | Image for the CL client                                                                                                                                                                                                                     |
...
| el_image                         | string | 0xpolygon/bor:2.8.3               | Image for the EL client (bor: `0xpolygon/bor:2.8.3`, erigon: `0xpolygon/erigon:v3.6.1-beta`)                                                                                                                                                |
...
| validator_config_generator | string | ghcr.io/0xpolygon/pos-validator-config-generator:0.9.0-beta2 | Image used to generate validator configs    |
