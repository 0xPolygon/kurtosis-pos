...
DEFAULT_IMAGES = {
    ...
    # layer 2
    "l2_cl_heimdall_v2_image": "0xpolygon/heimdall-v2:0.5.2",
    "l2_el_bor_image": "0xpolygon/bor:2.5.4",
    ...
    "pos_validator_config_generator_image": "europe-west2-docker.pkg.dev/prj-polygonlabs-devtools-dev/public/pos-validator-config-generator:0.5.2",
