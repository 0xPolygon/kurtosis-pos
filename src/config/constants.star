...
DEFAULT_IMAGES = {
    ...
    "l2_cl_queue_image": "rabbitmq:4.2.1",
    # utilities
    ...
    "pos_validator_config_generator_image": "europe-west2-docker.pkg.dev/prj-polygonlabs-devtools-dev/public/pos-validator-config-generator:0.5.5",
