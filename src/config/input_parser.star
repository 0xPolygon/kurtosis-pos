...
DEFAULT_POS_VALIDATOR_CONFIG_GENERATOR_IMAGE = "leovct/pos-validator-config-generator:1.3.3-0.2.4"  # Based on 0xpolygon/heimdall:1.3.3 and 0xpolygon/heimdall-v2:0.2.4.
...
DEFAULT_CL_IMAGES = {
    constants.CL_TYPE.heimdall: "0xpolygon/heimdall:1.3.3",
