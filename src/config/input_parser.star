...
DEFAULT_EL_IMAGES = {
    constants.EL_TYPE.bor: "0xpolygon/bor:fad6a09-fix",  # Based on 0xpolygon/bor:2.2.9 with heimdall migration monitor fix (https://github.com/maticnetwork/bor/compare/master...leovct:bor:2.2.9-fix).
