...
DEFAULT_POS_VALIDATOR_CONFIG_GENERATOR_IMAGE = "leovct/pos-validator-config-generator:1.2.3-0.1.32"  # Based on 0xpolygon/heimdall:1.2.3 and 0xpolygon/heimdall-v2:0.1.32.

DEFAULT_EL_IMAGES = {
    constants.EL_TYPE.bor: "0xpolygon/bor:2.0.3",
    constants.EL_TYPE.bor_modified_for_heimdall_v2: "leovct/bor:35f2fcf",  # There is no official image yet.
...
DEFAULT_E2E_TEST_IMAGE = "leovct/e2e: f258b02-pos"
