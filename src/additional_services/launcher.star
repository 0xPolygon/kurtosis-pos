...
def launch(
    ...
    for svc in additional_services:
        if svc == types.ADDITIONAL_SERVICES.blockscout:
            blockscout.launch(plan)
        elif svc == types.ADDITIONAL_SERVICES.prometheus_grafana:
        ...
        elif svc == types.ADDITIONAL_SERVICES.test_runner:
        ...
        elif svc == types.ADDITIONAL_SERVICES.tx_spammer:
