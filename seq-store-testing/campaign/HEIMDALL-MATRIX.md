...
- **H5 (kurtosis-pos).** RPC heimdall containers run `heimdalld init` on every start and die on restart; validator heimdalls do not. One-line guard fix proposed above.
